...
def voucher_received(cadde_provider=None, cadde_consumer=None, cadde_contract_id=None, hash_get_data=None, contract_management_service_url=None):  # noqa: E501
    ...
    logger.debug(
        get_message(
            '1F001N', [
                cadde_provider, cadde_consumer, cadde_contract_id, hash_get_data, contract_management_service_url, contract_management_service_key]))
    ...
    response = Response(response=voucher_result, status=200)
    return response
