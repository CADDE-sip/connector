...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GetLineageApi()
        api_instance.lineage  # this is an instance of the class Endpoint
        api_instance.lineage()  # this invokes api_instance.lineage.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.lineage.callable or self.callable in this class
