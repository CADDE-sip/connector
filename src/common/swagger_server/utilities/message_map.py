...
__MESSAGE_CODE_MAP = {
    ...
    '04014E': {'message': 'エラーが発生しました。エラー内容:{0[0]}', 'http_status_code': 401},
    ...
    '09004N': {'message': '提供者ID: {0[0]}, 利用者ID:{0[1]}, 取引ID:{0[2]}, ハッシュ値:{0[3]}, 契約管理サービスURL:{0[4]}'},
    ...
    '0A012E': {'message': '認可確認に失敗しました。対象のトークンが使用できないか、リソースURLに認可がありません。サイト管理者に問い合わせてください。'},
    '0A013N': {'message': 'トークン情報: {0[0]}, リソースID:{0[1]}'},
    '0A014E': {'message': 'エラーが発生しました。エラー内容:{0[0]}'},
    '0A015E': {'message': '対象のリソース情報に付加情報がありません。サイト管理者に問い合わせてください。'},
    ...
    '1A003E': {'message': '認証処理を行いましたが、対象の認証トークンは使用できません。サイト管理者に問い合わせてください。', 'http_status_code': 401},
    '1A004N': {'message': '利用者トークン:{0[0]}, 利用者コネクタID: {0[1]}, 利用者コネクタのシークレット:{0[2]}, IdP:{0[3]}'},
    '1A005E': {'message': 'エラーが発生しました。エラー内容:{0[0]}'},
    '1A006E': {'message': '認証トークン取得処理を行いましたが、対象の利用者トークンは使用できません。サイト管理者に問い合わせてください。', 'http_status_code': 401},
    ...
    '1F001N': {'message': '提供者ID: {0[0]}, 利用者ID:{0[1]}, 取引ID:{0[2]}, ハッシュ値:{0[3]}, 契約管理サービスURL:{0[4]}'},
