...
__MESSAGE_CODE_MAP = {
    ...
    '010002010E': {'message': '送来歴登録に必要な識別情報の値が不正です。コンフィグファイルの設定を確認してください。', 'http_status_code': 500},
    ...
    '010400004E': {'message': 'CADDEユーザID（利用者）に失敗しました。CADDE管理者に問い合わせください。', 'http_status_code': 500},
    ...
    '020302001N': {'message': '提供者ID: {0[0]}, 利用者ID:{0[1]}, 取引ID:{0[2]}, ハッシュ値:{0[3]}, 契約管理サービスURL:{0[4]}', 'http_status_code': 200},
