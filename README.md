...
1. コネクタ利用開始時は下記ファイルを記載し送付をお願いします。  
[コネクタ_利用登録申請書_2022年度版.xlsx](doc/form/コネクタ_利用登録申請書_2022年度版.xlsx) 

2. コネクタ利用後の問い合わせについては下記の記載をお願いします。  
*********<br>
...
⑨関連する過去の問い合わせ番号 <br>
**********<br><br>
構築中の不具合や動作不良に関する問い合わせの場合、下記ファイルを可能な範囲で記載の上、送付をお願いします。   
[コネクタ_問い合わせ確認事項_2022年度版.xlsx](doc/form/コネクタ_問い合わせ確認事項_2022年度版.xlsx) 
